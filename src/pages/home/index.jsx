                    ...
                    <div className="row gy-5">
                        <div className="col-lg-6 align-self-center">
                            ...
                            //<form className="mt-40 me-lg-5" action="https://app.headlessforms.cloud/api/v1/form-submission/J5AwbzdSw9" method="POST" encType="multipart/form-data">
                                <form accept-charset='UTF-8' action='https://app.formester.com/forms/8c183426-f1aa-4985-b970-f963cf78d00e/submissions' method='POST'>
                    ...
                    <div className="row mb-40">
                        <div className="mx-auto offset-xl-3 offset-lg-3 text-center">
                            <div className="text-center">
                                ...
                                <h2>Comprehensive Healthcare Marketing and Patient Acquisition Services at Your Fingertips</h2>
                                <p className="mx-4">Maximize Your Healthcare Business's Potential with Our All-inclusive Marketing Solutions. Our Services Include Digital Patient Acquisition, SEO, Reputation Management, and Sales Automation - Empowering You to Enhance Your Brand, Attract More Patients, and Achieve Measurable Outcomes.</p>
                            </div>
                        </div>
                    </div>
                    <div className="row">
